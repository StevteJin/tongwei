...
        "supportNum": "22"   //后勤人员人数
    ...
    const [Floor, setFloor] = useState([
        "综合指挥楼","留置用房","武警执勤楼","后勤保障楼","综合办公楼","中心办公楼","特警执勤楼","体能训练馆"
    ])
        ...
        switch (item) {
            ...
            case 5:
                var pos = {
                    ...
                    //x:7131,y:-10446.08203125,z:3158.668212890625,pitch:22.07482147216797,yaw:-88.81202697753906,roll:0.00007462623034371063
                }
                createMap.FlyToPosition(map, pos)
                createMap.closeWkWang(map)
                                ...
                                Object.keys(rygkData).length > 0 ?
                                    <div className="twobackgrounde" id="box">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <i></i>
                                                <p className="countNum center">{rygkData.invesGroupPeopleNum}</p>
                                            </li>
                                        </ul>
                                        <div className="arraw">
                    ...
                    <div className="BasesituationThreeya">
                                ...
                                </div> */}
                        {
                            Object.keys(khllData).length > 0 ? <div className="police">
                                 <ul>
                                    <li>
                                        <p><span className="wj">武警看护</span><span style={{marginLeft:"20px",marginTop:"4px"}}>{khllData.policeTotal}</span></p>
                                    </li>
                                    <li>
...
{/*                        <source src={require('../../assets/images/video/zhzhl.mp4').default} type="video/mp4"/> */}
                 <source src={require("../../../assets/images/video/V001_JZ0088.mp4").default} type="video/mp4"/>
                </video>
          </div>:null
           }
        </Fragment>
