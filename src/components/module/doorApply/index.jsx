...
const DoorApply=(props)=>{
    ...
    <div id="DoorApply" className="DoorApply animate_speed animate__animated animate__fadeInLeft">
            ...
            <ul>
                <li onClick={()=>caozuo(1)} className={count === "1"?"active":null}><img src={require("../../../assets/camera_img/km.png").default} alt=""></img><span>开门</span><span></span></li>
                <li onClick={()=>caozuo(2)} className={count === "2"?"active":null}><img src={require("../../../assets/camera_img/gb.png").default} alt=""></img><span>关门</span><span></span></li>
                <li onClick={()=>caozuo(0)} className={count === "0"?"active":null}><img src={require("../../../assets/camera_img/ck.png").default} alt=""></img><span>常开</span><span></span></li>
                <li onClick={()=>caozuo(3)} className={count === "3"?"active":null}><img src={require("../../../assets/camera_img/door-cb.png").default} alt=""></img><span>常关</span><span></span></li>
            </ul>
            <span className="doorapp-pop-record" onClick={()=>doorHistoryList()}>历史记录</span>
            </div>:""} 
            {doorHistory?<div className="doorHistory-pop">
                <p><span className="doorHistory-pop-tit">历史记录</span><img className="doorHistory-pop-cls" src={require("../../../assets/camera_img/back.png").default} alt="" onClick={()=>doorHistoryvisble()}></img></p>
                <ul>
