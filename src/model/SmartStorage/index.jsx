...
export default class SmartStorage extends Component {
    ...
    LoadDta(){
        fetch("http://121.196.181.211:8301/largescreen/largeScreen/getScreenData/storage")
        .then(res => res.json())
        .then(data => {
            console.log(data,"111111111111111111111111111111111")
            console.log(data.largeScreenModules[1].largeScreenModuleDetailes,"分类")
    ...
    async  CompletedSmartListppai(){
        ...
        .then(data => {
            ...
            console.log(data.largeScreenModules[0].largeScreenModuleDetailes,"分类")
            console.log(data.largeScreenModules[1].largeScreenModuleDetailes[3],"2222222222222222222222222222222")
